      ...
      <nav className="sticky top-0 z-50 w-full px-6 py-4 flex justify-center">
        <div className="glass glass-card w-full max-w-7xl flex justify-between items-center rounded-2xl py-3 px-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-primary-neon/10 flex items-center justify-center border border-primary-neon/30">
      ...
      <div className="relative z-10 w-full max-w-7xl px-6 flex flex-col items-center">
        ...
        <section className="relative w-full min-h-[90vh] flex flex-col items-center justify-center pt-20 pb-40 px-6 hero-gradient">
          ...
          <div className="relative z-10 w-full max-w-7xl flex flex-col items-center text-center">
            ...
            <h1 className="text-7xl md:text-[8rem] lg:text-[10rem] font-black mb-8 leading-[0.85] tracking-[-0.04em] animate-slide-up" style={{ animationDelay: '0.1s' }}>
              SONIC <br />
        ...
        <div className="relative z-20 w-full max-w-7xl px-6 -mt-20">
          {/* Partner / Trust Bar */}
          <div className="premium-glass rounded-[32px] py-10 px-8 flex flex-wrap justify-around items-center gap-12 mb-32 border-white/5">
          ...
          <section className="mb-40 text-center md:text-left flex flex-col md:flex-row items-center gap-20">
            ...
            <div className="flex-1 w-full">
              <div className="aspect-video premium-glass rounded-[40px] border border-white/10 p-2 overflow-hidden animate-float">
                 <div className="w-full h-full rounded-[32px] bg-gradient-to-br from-primary-neon/20 to-secondary-neon/20 flex items-center justify-center relative overflow-hidden">
